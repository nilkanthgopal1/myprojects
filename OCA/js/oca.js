...
function register()
{
  ...
  var student={firstname:firstname, lastname:lastname,pass:pass,confpass:confpass,email:email,mobile:mobile,country:country,state:state,
  ...
  req.onreadystatechange=function()
  {
	if(req.readyState==4 && req.status==200)
	{
	  ...
	  if(req.responseText==="Registration Successfull"){
		  alert("In if cond");
...
function login()
{
  ...
  var student={username:username,password:password};
